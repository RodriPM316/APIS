...
using Api.Empleados.Utilidades;
using AutoMapper;
...
namespace Api.Empleados.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public UsuariosController(UserManager<Usuario> userManager, IConfiguration configuracion, 
        ...
        {
            var usuario = await context.Users.ToListAsync();
            var usuarioDTO = mapper.Map<IEnumerable<UsuarioDTO>>(usuario);
            return usuarioDTO;
        }
        ...
        [Authorize(Policy = "esadmin")]
        public async Task<ActionResult> RemoverrAdmin(EditarClaimDTO editarClaimDTO)
        {
            var usuario = await userManager.FindByEmailAsync(editarClaimDTO.Email);
